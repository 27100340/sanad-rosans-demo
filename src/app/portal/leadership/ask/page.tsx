...
export default async function AskTheSchoolPage() {
  ...
  return (
    <div className="space-y-8 sm:space-y-10">
      <PageHeader eyebrow="Leadership" title="Ask the School" description="Plain-language questions over live aggregates. No student record leaves the school." actions={<AiPill live={aiIsLive()} />} />
